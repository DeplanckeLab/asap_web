...
import MarkersRunStatusController from "controllers/markers_run_status_controller"
application.register("markers-run-status", MarkersRunStatusController)
console.log('Markers run status controller registered')
