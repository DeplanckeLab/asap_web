...
#  url = "ftp://ftp.flybase.org/releases/current/precomputed_files/genes/automated_gene_summaries.tsv.gz"
  url = "https://s3ftp.flybase.org/releases/current/precomputed_files/genes/automated_gene_summaries_fb_2025_05.tsv.gz"
  puts url  
...
#puts sum #.split(/[\r\n]+/).join(",")
 ...
 #   url = "ftp://ftp.flybase.org/releases/current/precomputed_files/genes/gene_snapshots_fb_#{m[1]}.tsv.gz"
    url = "https://s3ftp.flybase.org/releases/current/precomputed_files/genes/gene_snapshots_fb_#{m[1]}.tsv.gz"
